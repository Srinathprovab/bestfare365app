...
class ExtraBaggagesTVCell: TableViewCell {
    ...
    func setupUI() {
        ...
        setuplabels(lbl: titlelbl, text: "Purchase your Extra Baggages", textcolor: .AppLabelColor, font: .ProximaNovaBold(size: 16), align: .left)
        setuplabels(lbl: selectPassengerlbl, text: "Select the Passenger", textcolor: .AppLabelColor, font: .ProximaNovaRegular(size: 14), align: .left)
