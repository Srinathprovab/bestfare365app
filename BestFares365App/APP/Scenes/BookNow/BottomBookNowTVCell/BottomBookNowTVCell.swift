...
class BottomBookNowTVCell: UITableViewCell {
    ...
    func setupUI() {
        holderView.addCornerRadiusWithShadow(color: .AppLabelColor.withAlphaComponent(0.16), borderColor: .BorderColor, cornerRadius: 8)
        holderView.backgroundColor = .WhiteColor
        setupLabels(lbl: titlelbl, text: "A$250", textcolor: .AppLabelColor, font: .ProximaNovaBold(size: 20))
