...
class BaggageInfoTVCell: UITableViewCell {
    ...
    func setupUI(){
        ...
        setupLabels(lbl: titlelbl, text: "Cabin bag", textcolor: .LabelTitleColor, font: .ProximaNovaRegular(size: 14))
        setupLabels(lbl: subtitlelbl, text: "7 kg", textcolor: .LabelTitleColor, font: .ProximaNovaRegular(size: 14))
