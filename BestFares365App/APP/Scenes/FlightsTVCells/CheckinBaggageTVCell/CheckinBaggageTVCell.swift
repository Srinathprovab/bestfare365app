...
class CheckinBaggageTVCell: TableViewCell {
    ...
    func setupUI() {
        ...
        setuplabels(lbl: titlelbl, text: "Checkin baggage included free", textcolor: .LabelTitleColor, font: .ProximaNovaBold(size: 16), align: .left)
        setuplabels(lbl: cityCodelbl, text: "DXB - KWI", textcolor: .LabelTitleColor, font: .ProximaNovaBold(size: 20), align: .left)
        setuplabels(lbl: baggagelbl, text: "includes 30 kg of checkin baggage free", textcolor: .LabelTitleColor, font: .ProximaNovaRegular(size: 12), align: .left)
